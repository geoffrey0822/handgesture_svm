function [class,score,outImg]=detection4_s(src,learners,filters,smoothFilter,colorSpace,...
    cellSize,blockSize,blockOverlap,edgeTheshold)
    [fImg,edge,color]=imgProc2NF_s(src,filters,smoothFilter,colorSpace,edgeTheshold);
